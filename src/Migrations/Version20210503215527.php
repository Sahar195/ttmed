 ...
 */
final class Version20210503215527 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE dossier_medical (id INT AUTO_INCREMENT NOT NULL, les_donnees_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_3581EE6270826EA2 (les_donnees_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fiche_medicale (id INT AUTO_INCREMENT NOT NULL, dossier_medical_id INT DEFAULT NULL, type VARCHAR(30) NOT NULL, observation VARCHAR(255) NOT NULL, prescription VARCHAR(255) NOT NULL, INDEX IDX_20D23267750B79F (dossier_medical_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
