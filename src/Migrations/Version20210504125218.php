 ...
 */
final class Version20210504125218 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE infirmier MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE infirmier DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE infirmier DROP id, CHANGE matricule_inf matricule_inf INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE infirmier ADD PRIMARY KEY (matricule_inf)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE adminin_rh (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE infirmier ADD id INT AUTO_INCREMENT NOT NULL, CHANGE matricule_inf matricule_inf INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
